 // Jornada TIC
// Este script efetua a compra de um Construtor de Site no Boleto
// @author: Marcos Lima

import {userPj} from "../mocks/users.mocks"

describe('TIC - Construtor de Site', function () {
	const user = userPj
    const datasites = [
	{
	    period: 'Mensal',
    ...
    function checking(site) {
        it('Pagamento: Boleto', function () {
			...
			cy.get('#planos-construtor-site > div.mc.center.mt10.flex.justify-center > div > div > ul > div:nth-child(1) > div.relative.undefined > div.f14.pt16.pb12.ph12.pb24-ns > div.db.flex.justify-center.mt12.mt16-ns > button').click()
