 // Jornada TIC
// Este script efetua o relatório das ofertas de Telefonia Fixa para as cidades com Expansão Combate
// @author: Marcos Lima

describe('Ofertas Fixo Empresas - Expansão Combate', function () {
	///*    
	const cities = [
	{
	    name: 'ARAGUARI',
